...
public class Test02 {
	...
	public static void main(String[] args) {
		...
		int len2 = ((String)arr2[0]).length(); // length() 메소드는 String 클레스에 있기때문에 타입 변환 해야함
		...
		Iterator<String> iter = list.iterator();//iterator()는 iterator<String> 객체를 반환 iter 객체는 list의 첫번째 요소를 앞을 가르킴
		//480페이지 1번째 문단 
		while (iter.hasNext()) {
